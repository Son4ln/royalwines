...
class ProductDetailAside extends React.Component {
  constructor() {
    super();
  }
      ...
      <section className="ct-sidebar ct-js-sidebar ct-js-background ct-u-displayTable ct-u-hideAnimateBg" data-bg="/public/assets/site/images/content/demo2.jpg">
        <div className="ct-sidebar-inner">
          <div className="item">
            ...
            <h2 className="ct-u-font2 text-uppercase animated " data-fx="flipInY">chi tiết<br/>sản phẩm</h2>
            <p className="animated" data-fx="fadeIn">Sản phẩm, mô tả, trạng thái</p>
